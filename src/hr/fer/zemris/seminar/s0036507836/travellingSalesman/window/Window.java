...
public class Window extends JFrame {
    ...
    public void setInputEnabled(boolean enabled) {
    	this.bestPathLength.setEditable(enabled);
    	this.maxGenerations.setEditable(enabled);
    	this.populationSize.setEditable(enabled);
    	this.mutationRate.setEnabled(enabled);
    	this.cities.setEnabled(enabled);
    	this.slowTime.setEnabled(enabled);
    }
    
    public void disableWhileRunning(boolean enabled) {
   		...
   		start.addActionListener((evt) -> {
    		...
    		new Thread(() -> {
	        	...
	        	if(isBruteForce) {
		        	...
		        	evolver.run();
		        	info("Genetic algorithm finished");
